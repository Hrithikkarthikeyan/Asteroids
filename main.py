...
player = pygame.image.load('asteroidsPics/space_ship.svg')
...
def redrawGameWindow():
    ...
    playAgainText = font.render('Press Tab to Play Agian', 1 ,(255,255,255))
    ...
    if rapidFire:
        pygame.draw.rect(win, (0, 0, 0), [sw//2 - 51, 19, 100, 22])
        ...
        for i, a in enumerate(aliens):
            ...
            for b in playerBullets:
                if (b.x >= a.x and b.x <= a.x + a.w) or (b.x + b.w >= a.x and b.x + b.w <= a.x + a.w):
                    if (b.y >= a.y and b.y <= a.y + a.h) or (b.x + b.h >= a.y and b.y + b.h <= a.y + a.h):
                        aliens.pop(i)
                        if isSoundOn:
                            bangLargeSound.play()
                        score += 50
        ...
        for s in stars:
            ...
            for b in playerBullets:
                if (b.x >= s.x and b.x <= s.x + s.w) or (b.x + b.w >= s.x and b.x + b.w <= s.x + s.w):
                    if (b.y >= s.y and b.y <= s.y + s.h) or (b.x + b.h >= s.y and b.y + b.h <= s.y + s.h):
                        rapidFire = True
                        rfStart = count
                        stars.pop(stars.index(s))
                        playerBullets.pop(playerBullets.index(b))
